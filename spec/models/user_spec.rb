...
describe User do
  ...
  describe "when email format is invalid" do
  	it "should be invalid" do
  		addresses = %w[user@foo,pl user_at_foo.org example.user@foo. foo@bar_baz.com foo@bar+baz.com]
   ...
   describe "when email format is valid" do
  	it "should be valid" do
  		addresses = %w[user@foo.PL A_US-ER@f.b.org example.user@foo.jp foo+cos@bar.com]
